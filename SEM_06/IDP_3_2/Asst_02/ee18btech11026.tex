...
\title{EE3025 INDEPENDENT PROJECT \\ Assignment : 02}
...
\tcbox{https://github.com/Surya291/ACADEMIA/tree/master/IDP\_3\_2/Asst\_02/codes}

and latex code from 
\tcbox{https://github.com/Surya291/ACADEMIA/tree/master/IDP\_3\_2/Asst\_02/ee18btech11026.tex}
...
The below code computes the above mentioned quantities and generates Fig 1.
\tcbox{./codes/IIR/paraplot.py}
\tcbox{./codes/IIR/para.py} 


 
\begin{figure}
\label{fig1}
\includegraphics[width = 15cm]{./codes/IIR/figs/parameter_plots.eps}
\caption{The Analog Low-Pass Frequency Response for $0.35 \leq \epsilon \leq 0.6$}
\end{figure}
We choose $\epsilon = 0.4$  for our IIR filter design.Generated a low pass filter plot for $\epsilon = 0.4$ in Figure 2

The below code generates Figure 2 

\tcbox{./codes/IIR/lpanalog.py} 


\begin{figure}
\label{fig2}
\includegraphics[width = 15cm]{./codes/IIR/figs/specifications.eps}
...
\end{equation}
The below code computes the above formulations  

\tcbox{./codes/IIR/lp\_stable\_cheb.py} 
...
Plotting the magnitude response for analog lowpass filter in Figure 3 which is generated using the below code

\begin{figure}
\label{fig3}
\includegraphics[width = 15cm]{./codes/IIR/figs/Analog_IIR_lowpass.eps}
\caption{The magnitude response of  analog lowpass IIR filter }
\end{figure}
...
\begin{figure}
\label{fig4}
\includegraphics[width = 15cm]{./codes/IIR/figs/Analog_IIR_Bandpass.eps}
...
The below code generates Figures 3, 4, 5
\tcbox{./codes/IIR/iir\_final.py} 


\begin{figure}
\label{fig5}
\includegraphics[width = 15cm]{./codes/IIR/figs/Digital_IIR_Bandpass.eps}
...
\begin{figure}
\label{fig6}
\includegraphics[width = 15cm]{./codes/FIR/figs/FIR_lowpass.eps}
\caption{Magnitude response of the FIR lowpass digital filter } 
\end{figure}

\subsection{Converting into a causal FIR Bandpass Filter}
...
A low pass filter's impulse response can be converted into a band pass using the below transformation
\begin{eqnarray}
h_{bp}(n) = h_{lp}(n)* 2cos(n\omega_c)
\end{eqnarray}

The magnitude response of the FIR bandpass filter designed to meet the given specifications is plotted in Figure 7.

The below code computes the FIR filter specifications and generates Figures 6,7
\tcbox{./codes/FIR/test.py} 


\begin{figure}
\label{fig7}
\includegraphics[width = 15cm]{./codes/FIR/figs/FIR_bandpass.eps}
\caption{Magnitude response of the FIR bandpass digital filter obtained using (\ref{lphp})} 
\end{figure}
